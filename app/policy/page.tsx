    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-2xl w-full">
        ...
        <section className="mb-6">
          ...
          <p>
            The YouTube to Spotify Playlist Creator is a web application that allows users to create Spotify playlists from their Facebook-shared YouTube videos. We prioritize user privacy and data protection in our service.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            Our application is designed with privacy in mind:
          </p>
        ...
        <section className="mb-6">
          ...
          <p>
            To comply with privacy regulations, users of YouTube to Spotify Playlist Creator can easily manage their data:
          </p>
        ...
        <section className="mb-6">
          ...
          <p>
            If you have any questions about our data handling practices or need assistance, please contact us at: support@youtubetospot
ify.com
          </p>
        </section>
